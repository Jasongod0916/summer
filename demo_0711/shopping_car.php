...
<body>
    <p align="center"><img src='cat.jpg' width="100"></p>
    ...
    <table border="0" align="center" width="800">
        ...
        if (empty($_COOKIE["book_no_list"])) {
            ...
            for ($i = 0; $i < count($book_no_array); $i++) {
                ...
                echo "<td align='center'>$". $sub_total. "</td>"; echo "<td align='center'><input type='submit' value='修改'></td>";
                echo "</tr>";
                echo "</form>";
                }
                ...
                echo "</tr>";
                echo "<tr align='center'>";
                echo "<td colspan='6'>". "<br><input type='button' value='返回所有商品'
